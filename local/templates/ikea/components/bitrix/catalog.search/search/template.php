        ...
        if (is_array($arElements)) {
	        ...
	        <div class="catalog-section">
		        <div class="container">
			        ...
			        <div class="search-result_header">Нет совпадений по запросу<span class="search-result_title"><?=$_REQUEST['q'];?></span></div>
			        <div class="search_no-result">
				        <span class="search_large-icon ico-search"></span>
				        <p>Повторите попытку, используя другое написание <br>или ключевые слова.</p>
			        </div>
		        </div>
	        </div>
	        <?
...
<div class="catalog-section">
	<div class="container">
		...
		<div class="search-result_header">Результаты поиска: <span class="search-result_title"><?=$_REQUEST['q'];?></span></div>
        <? if (!empty($searchFilter) && is_array($searchFilter)) {
            $GLOBALS['arrPreSearchFilter'] = $searchFilter;
            ...
            $APPLICATION->IncludeComponent(
                ...
                array(
                    ...
                    "IBLOCK_ID" => $arParams["IBLOCK_ID"],
                    "FILTER_NAME" => 'searchFilter',
                    "PREFILTER_NAME" => 'arrPreSearchFilter',
                    "PRICE_CODE" => $arParams["~PRICE_CODE"],
                    "CACHE_TYPE" => $arParams["CACHE_TYPE"],
                    "CACHE_TIME" => $arParams["CACHE_TIME"],
