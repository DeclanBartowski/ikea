...
jQuery(document).ready(function($) {
	...
	$(document).on('click','.catalog_filter-btn', function() {
	...
	$(document).on('click','.catalog-filter_close-btn', function() {
		$('.filter-fixed').removeClass('is-open');
  ...
  setProgress(0);
	...
	$(document).on('click','.filter_price-label',function(){
		$('.filter_price-dropdown').slideToggle(10);
		$(this).toggleClass('is-active');
	});
	$(document).on('click','.catalog-filter_item-title', function() {
